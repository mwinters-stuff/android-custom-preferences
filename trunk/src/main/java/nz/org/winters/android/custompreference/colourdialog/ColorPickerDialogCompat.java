package nz.org.winters.android.custompreference.colourdialog;
 ...
 */
public class ColorPickerDialogCompat extends DialogFragment implements ColorPickerSwatch.OnColorSelectedListener
{
  ...
  public ColorPickerDialogCompat()
  {
    // Empty constructor required for dialog fragments.
  }

  public static ColorPickerDialogCompat newInstance(int titleResId, int[] colors, int selectedColor,
                                                    int columns, int size)
  {
    ColorPickerDialogCompat ret = new ColorPickerDialogCompat();
